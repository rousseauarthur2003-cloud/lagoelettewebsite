      ...
      {showPopup && (
        <>
          <style>{`
            ...
            .goelette-popup-contact:hover {
              transform: translateY(-1px);
              background: #142b20;
            }

            .goelette-popup-book:hover {
              transform: translateY(-1px);
              background: #9d793d;
            }
          ...
          >
            <div className="goelette-popup">
              ...
              <div className="goelette-popup-content">
                ...
                <div className="goelette-popup-actions">
                  <a className="goelette-popup-button goelette-popup-contact" href="tel:+33251276488">
                    Nous contacter
                  </a>

                  <a
                    className="goelette-popup-button goelette-popup-book"
                    href="https://book.squareup.com/appointments/ikwme6p7e06f9h/location/LJPKCPFFXM5QF/services"
                    target="_blank"
